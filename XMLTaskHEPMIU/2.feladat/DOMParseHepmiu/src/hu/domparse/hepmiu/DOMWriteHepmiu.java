...
public static void main(String[] args) {
	...
	private static void addElements(Document document, Element rootElement) {
		...
		addHadsereg(document, rootElement,"2", "5000",
				"Hungary","Dunántúl","gyenge", "erõs", "gyenge");
		addHadsereg(document, rootElement,"3", "14000",
				"Hungary","Vajdaság","közepes", "erõs", "erős");
		addFoparancsnok(document, rootElement, "4545", "1", "Nagy József", "vezérezredes", "56", "30");
		addFoparancsnok(document, rootElement, "4545", "2", "Hári János", "tábornagy", "52", "32");
		addFoparancsnok(document, rootElement, "4545", "3", "Kovács Zétény", "tábornok", "58", "36");
	...
	private static void printDocument(Document document) {
		 try {
	            ...
	            NodeList foparancsnok = document.getElementsByTagName("Főparancsnok");
	            NodeList tisztek = document.getElementsByTagName("Tisztek");
	            NodeList katonak = document.getElementsByTagName("Katonák");
	            NodeList szarazfoldierok = document.getElementsByTagName("Szárazföldi_erők");
	            NodeList tengereszet = document.getElementsByTagName("Tengerészet");
	            NodeList legiero = document.getElementsByTagName("Légierő");
